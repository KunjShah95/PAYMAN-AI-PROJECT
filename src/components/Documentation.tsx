  ...
  const sections: Section[] = [
    {
      ...
      content: (
        <>
          <h3 className="text-xl font-semibold mb-2">Welcome to PaymanAI</h3>
          <p className="mb-4">PaymanAI is an AI-powered property management platform designed to simplify rent collection, tenant management, and property analytics.</p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">PaymanAI offers a comprehensive API for developers who want to integrate our services into their applications.</p>
          <h4 className="text-lg font-semibold mb-2">Base URL</h4>
          <code className="block bg-gray-700 text-gray-200 p-2 rounded mb-4">https://api.payman.ai/v1</code>
          <h4 className="text-lg font-semibold mb-2">Authentication</h4>
          <p className="mb-2">All API requests require an API key passed in the header:</p>
          <code className="block bg-gray-700 text-gray-200 p-2 rounded mb-4">Authorization: Bearer YOUR_API_KEY</code>
          <h4 className="text-lg font-semibold mb-2">Common Endpoints</h4>
    ...
    },
    {
      ...
      content: (
        <>
          <h3 className="text-xl font-semibold mb-2">Authentication Methods</h3>
          <p className="mb-4">PaymanAI supports multiple authentication methods for secure access:</p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">PaymanAI supports various payment methods to accommodate different tenant preferences:</p>
          <ul className="list-disc pl-4 space-y-2 mb-4">
          ...
          <h4 className="text-lg font-semibold mb-2">Processing Fees</h4>
          <div className="overflow-x-auto">
            <table className="min-w-full">
              ...
              <tbody>
                <tr className="border-b">
                  <td className="px-4 py-2">Credit/Debit Card</td>
                  <td className="px-4 py-2">2.9% + $0.30</td>
                </tr>
                <tr className="border-b">
                  <td className="px-4 py-2">ACH Transfer</td>
                  <td className="px-4 py-2">0.8% (capped at $5)</td>
                </tr>
                <tr>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">At PaymanAI, we prioritize the security of your data and implement multiple layers of protection:</p>
          <ul className="list-disc pl-4 space-y-2 mb-4">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">PaymanAI leverages artificial intelligence to enhance your property management experience:</p>
          <ul className="list-disc pl-4 space-y-2 mb-4">
          ...
          <h4 className="text-lg font-semibold mb-2">Machine Learning Models</h4>
